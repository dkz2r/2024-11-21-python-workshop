...
latitude: "50.780790"        # decimal latitude of workshop venue (use https://www.latlong.net/)
...
startdate: 2024-11-21      # machine-readable start date for the workshop in YYYY-MM-DD format like 2015-01-01
enddate: 2024-11-22        # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
instructor: ["Catherine Gonzalez", "Jonathan Hartman"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Nicole Parks", "Tarek Iraki", "Marc-André Hermanns"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
collaborative_notes: https://pad.otc.coscine.dev/2024-11-21-python-workshop  # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document (e.g., https://pad.carpentries.org/2015-01-01-euphoria)
...
Alternatively, you can register for the workshop <strong><a href="https://cryptpad.fr/form/#/2/form/view/EwekXMW26ZA8gW1n-k-np2trHTG4oC+G-K9XyZ8R5+Y/">HERE</a></strong>
